...
// Grab NODE_ENV and GAMMA_* environment variables and prepare them to be
// injected into the application via DefinePlugin in Webpack configuration.
const GAMMA = /^GAMMA_/i

function getClientEnvironment(target, options) {
  const raw = Object.keys(process.env)
    .filter(key => GAMMA.test(key))
    .reduce(
      (env, key) => {
      ...
      },
      {
        ...
        GAMMA_ASSETS_MANIFEST: paths.appManifest,
